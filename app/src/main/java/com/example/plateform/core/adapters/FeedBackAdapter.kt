...
import com.example.android.databinding.FeedbackListBinding

class FeedBackAdapter(
    private val context: Context,
    private var dataList: ArrayList<String>
) :
    RecyclerView.Adapter<FeedBackAdapter.BindViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BindViewHolder {

        val rootView: ViewDataBinding =
            FeedbackListBinding.inflate(LayoutInflater.from(context), parent, false)
